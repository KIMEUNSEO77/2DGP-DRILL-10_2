...
class Idle:
    ...
    def do(self):
        self.boy.frame = (self.boy.frame + FRAMES_PER_SECOND * game_framework.frame_time) % 8
...
class Sleep:
    ...
    def draw(self):
        if self.boy.face_dir == 1:
            ...
            self.boy.image.clip_composite_draw(int(self.boy.frame) * 100, 100, 100, -3.141592/2, '', self.boy.x + 25, self.boy.y - 25, 100, 100)
...
class Boy:
    ...
    def fire_ball(self):
        ball = Ball(self.x, self.y, self.face_dir * 10, 60)
